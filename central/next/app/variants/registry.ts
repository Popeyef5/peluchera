...
export const VARIANTS: Variant[] = [
	{ slug: "default", label: "Current (liquid glass)", notes: "Live main page — Bricolage Grotesque + Geist Mono, holographic accents." },
	{ slug: "old", label: "Old (prize pool)", notes: "Pre-migration layout — pool/multiplier UI on Chakra." },
